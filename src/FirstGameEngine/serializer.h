...
namespace game_engine::ecs
{
    struct serializer
    {
        GAMEENGINE_INLINE serializer(registry* reg) : _registry(reg) {}
        ...
        GAMEENGINE_INLINE void serialize_info(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_info(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_transform(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_transform(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_rigidbody(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_rigidbody(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_collider(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_collider(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_sprite(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_sprite(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_animation(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_animation(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_text(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_text(YAML::Node node, entity& e)
        {
        ...
        GAMEENGINE_INLINE void serialize_script(YAML::Emitter& em, entity& e)
        {
        ...
        GAMEENGINE_INLINE void deserialize_script(YAML::Node node, entity& e)
        {
