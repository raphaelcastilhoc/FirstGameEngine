...
namespace game_engine
{
    ...
    {
        GAMEENGINE_INLINE asset_serializer(asset_registry* assets) : _assets(assets) {}
        ...
        GAMEENGINE_INLINE void deserialize(YAML::Node& nodes, SDL_Renderer* r)
        {
            // clear registry
            _assets->clear();
        ...
        GAMEENGINE_INLINE void serialize_textures(YAML::Emitter& em)
        {
        ...
        GAMEENGINE_INLINE void deserialize_texture(YAML::Node node, SDL_Renderer* target)
        {
        ...
        GAMEENGINE_INLINE void serialize_animations(YAML::Emitter& em)
        {
        ...
        GAMEENGINE_INLINE void deserialize_animation(YAML::Node node)
        {
        ...
        GAMEENGINE_INLINE void serialize_audios(YAML::Emitter& em)
        {
        ...
        GAMEENGINE_INLINE void deserialize_audio(YAML::Node node)
        {
        ...
        GAMEENGINE_INLINE void serialize_fonts(YAML::Emitter& em)
        {
        ...
        GAMEENGINE_INLINE void deserialize_font(YAML::Node node)
        {
